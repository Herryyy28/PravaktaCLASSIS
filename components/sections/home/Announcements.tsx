...
const announcements = [
  ...
  { tag: "Admissions Open",  color: "bg-green-100 text-green-700", title: "IELTS Batch 2026 – Enrolments Open",      date: "August 25, 2026",   desc: "New IELTS batch starting soon with flexible online and offline options. Book your free trial class." },
